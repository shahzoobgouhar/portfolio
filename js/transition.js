...
var mediaLg = window.matchMedia("(max-width: 1024px)");
var mediaXl = window.matchMedia("(min-width: 1025px)");
...
function isVisible(elem) {
  ...
  if (
    bottom_of_screen + 50 > top_of_element &&
